...
_Distance to Hot Spot_ - The final factor considered is the distance to a "hot spot" location, defined as major clusters of failed inspections in Chicago at a 99% or greater significance level. This time, the nearest neighbor function will be used to find the distance to a hot spot location.
